...
Read in the file
```{r}
json <- fromJSON('https://raw.githubusercontent.com/kac624/cuny/main/D607/data/week7_books.json')
json <- read_text('https://raw.githubusercontent.com/kac624/cuny/main/D607/data/week7_books.json')


json <- fromJSON('data/week7_books.json')
json <- read_json('data/week7_books.json')
```
