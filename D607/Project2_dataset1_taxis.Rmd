...
```{r}
aggregated_df_all_2 %>% filter(location != 0, location != 264, location != 265) %>% group_by(year, type, location) %>% summarize (pickups = sum(pickups)) %>% arrange(desc(pickups))
```
