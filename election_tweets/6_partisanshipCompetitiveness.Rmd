...
candidates_sf <- candidates_sf %>%
  mutate(compete_cookpvi_norm = 
           (compete_cookpvi - min(compete_cookpvi, na.rm = T)) / 
           (max(compete_cookpvi, na.rm = T) - min(compete_cookpvi, na.rm = T)),
         cookpvi_nominate = abs(compete_cookpvi_norm - partisan_score_nominate),
         cookpvi_govtrack = abs(compete_cookpvi_norm - partisan_score_govtrack),
